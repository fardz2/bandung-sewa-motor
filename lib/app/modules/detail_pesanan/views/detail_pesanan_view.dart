            ...
            children: [
              ...
              Row(
                children: [
                  Container(
                    ...
                    child: controller.gambar_motor.value.isEmpty
                        ? const SizedBox(
                            height: 10,
                          )
                        : Center(
                            child: Image.network(
                              controller.gambar_motor.value,
                              width: 40,
                            ),
                          ),
                  ),
              ...
              Container(
                ...
                child: Text(
                  ...
                  style: const TextStyle(color: const Color(0xff4F4F4F)),
                ),
              ),
              const SizedBox(height: 16),
              const Text(
                ...
                children: [
                  Column(
                    ...
                    children: [
                      ...
                      Text(
                        controller.tanggal_pengambilan.value,
                      ),
                    ],
                  ),
                  Container(
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Text(
                        controller.tanggal_pengembalian.value,
                      ),
                    ],
                  ),
                ],
